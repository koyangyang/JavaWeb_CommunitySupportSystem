...
<head>
    ...
    <script src="https://cdn.jsdelivr.net/npm/@bootcss/v3.bootcss.com@1.0.10/assets/js/ie8-responsive-file-warning.js"></script><![endif]-->
            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <%
                        ...
                        ArrayList<his> hlist=hdi.getAllhis();
                        for(his g:hlist){
                            out.print("<tr><td>"+g.getId()+"</td><td>"+g.getUser()+"</td><td>"+g.getContent()+"</td><td>"+g.getDate()+"</td><td><a href='/dodelhis?id="+g.getId()+"'>删除</a></td></tr>");
                        }
                    %>
                    </tbody>
                </table>
