            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <%
                        ...
                        for(event g:glist){
                            out.print("<tr><td>"+g.getId()+"</td><td>"+g.getName()+"</td><td>"+g.getPrice()+"</td><td>"+g.getContent()+"</td><td>"+g.getDate()+"</td><td>"+g.getUser()+"</td><td><a href='/dodel?id="+g.getId()+"'>删除</a></td></tr>");
                        }
                    %>
                    </tbody>
                </table>
